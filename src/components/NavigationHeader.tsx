...
import { Bell, Menu, Users, MessageCircle, HeartPulse, UserPlus } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" onClick={() => navigate("/patient/notifications")} className="relative hover:bg-[#5B68EE]/10">
              <Bell className="w-5 h-5 text-[#5B68EE]" />
              <Badge className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center p-0 text-xs bg-[#5B68EE]">3</Badge>
            </Button>
